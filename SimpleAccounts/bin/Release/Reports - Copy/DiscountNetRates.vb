...
Public Class DiscountNetRates
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.DiscountNetRates.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDiscountNetRates
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DiscountNetRates = New DiscountNetRates()
        rpt.Site = Me.Site
        Return rpt
    End Function
