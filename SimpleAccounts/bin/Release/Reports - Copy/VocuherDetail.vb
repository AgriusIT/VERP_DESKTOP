...
Public Class VocuherDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.VocuherDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVocuherDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VocuherDetail = New VocuherDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
