...
Public Class frmUserRightsList
    Implements IGeneral
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            ...
            If Me.grdAdvanceType.RootTable.Columns.Contains("Delete") = False Then
                ...
                Me.grdAdvanceType.RootTable.Columns("UserName").Caption = "Head Name"
                Me.grdAdvanceType.RootTable.Columns("UserName").Width = 200
                Me.grdAdvanceType.RootTable.Columns("CustomerName").Caption = "User Name"
    ...
    Public Sub FillCombos(Optional Condition As String = "") Implements IGeneral.FillCombos
        ...
        ElseIf Condition = "Customer" Then
            ...
            Me.cmbCustomer.DisplayLayout.Bands(0).Columns("User_ID").Hidden = True
            Me.cmbCustomer.DisplayLayout.Bands(0).Columns("FullName").Width = 200
        End If
    End Sub
            ...
            If IsValidate() = True Then
                ...
                For Each row As Janus.Windows.GridEX.GridEXRow In Me.grdAdvanceType.GetDataRows
                    If Val(row.Cells("CustomerId").Value) = Me.cmbCustomer.Value Then
                        msg_Error("Selected User Exists Already")
                        Exit Sub
                    End If
                Next
