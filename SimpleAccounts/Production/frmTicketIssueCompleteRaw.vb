...
Public Class frmTicketIssueCompleteRaw
    Implements IGeneral
    ...
    Public Sub CallBtnSearch()
        Try
            If Not Me.cmbSalesOrder.SelectedValue <= 0 AndAlso Not Me.cmbPlanNo.SelectedValue <= 0 AndAlso Not Me.cmbTicketNo.SelectedValue <= 0 AndAlso Not Me.cmbStage.SelectedValue <= 0 Then
                btnSearch_Click(Nothing, Nothing)
            End If
        Catch ex As Exception
            Throw ex
