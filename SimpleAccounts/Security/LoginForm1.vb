...
Public Class LoginForm1
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            ...
            If Date.Today > "14-Aug-2012" Then msg_Error("An error occured, application will be terminated  " & Chr(13) & "Error No: 114 - Registery Check Error ...." & Chr(13) & Chr(13) & Chr(13) & "Please contact " & Chr(13) & "SIRIUS BUSINESS SOLUTIONS" & Chr(13) & Chr(13) & "Phone: +92 42 37552020 " & Chr(13) & "E-Mail: info@siriussolution.com" & Chr(13) & "Web: www.siriussolution.com") : End
        ...
        Catch ex As Exception
            msg_Error("An error occured while connecting the server....  " & Chr(13) & ex.Message)
            Exit Sub
        End Try
        ...
        ElseIf strUserValidity = "Valid" Then
            ...
            End If
            If GetConfigValue("SIRIUSPartner").ToString = "True" Then
                Dim Config As Configuration = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None)
                Dim ConfigSection As AppSettingsSection = Config.AppSettings
                If Not ConfigSection Is Nothing Then
                    If ConfigSection.IsReadOnly = False AndAlso ConfigSection.SectionInformation.IsLocked = False Then
            ...
            If Me.Text = str Then
                'frmMain.UltraStatusBar2.Panels(0).Text = "User: " & LoginUserName.ToUpper
            End If
            ...
            Try
                ...
                If SBDal.UtilityDAL.IsMachineVerified(System.Environment.MachineName.ToString) = False Then
                    ...
                    If dt.Rows.Count > 200 Then
                        msg_Error("Trial period is expired..." & Chr(10) & "Please register your software copy as soon as possible.")
                        RegisterStatus = EnumRegisterStatus.Expired
                    ElseIf dt.Rows.Count > 100 Then
                        msg_Information("You are using trial version..." & Chr(10) & "Please register your software copy to aviod any problem")
                    End If
                End If
                ''insert Activity Log
