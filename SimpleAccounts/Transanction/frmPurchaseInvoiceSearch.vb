    ...
    Private Sub BtnLoad_Click(sender As Object, e As EventArgs) Handles BtnLoad.Click
        Try
            ...
            For Each row As Janus.Windows.GridEX.GridEXRow In grdItems.GetCheckedRows
                ...
                frmPaymentNew.txtReference.Text = "Cash Paid against Invoice No. " & row.Cells("ReceivingNo").Value.ToString & ""
    ...
    Private Sub cmbCustomer_ValueChanged(sender As Object, e As EventArgs) Handles cmbCustomer.ValueChanged
        Try
            ...
            If Me.dtpFromDate.Checked = True Then
                str += " AND ReceivingDate >= Convert(Datetime, N'" & Me.dtpFromDate.Value.ToString("yyyy-M-d 00:00:00") & "', 102)"
                    End If
            If Me.dtpToDate.Checked = True Then
                str += " AND ReceivingDate <= Convert(Datetime, N'" & Me.dtpToDate.Value.ToString("yyyy-M-d 23:59:59") & "', 102)"
                    End If
