    ...
    Sub PopulateGrid(Optional ByVal strCondition As String = "")
        Try
            ...
            If Mode = "Normal" Then
                ...
                ''TASK TFS2018 addition of two new columns name CheckedUser and PostedUsert on 02-01-2018
              ...
              & " WHERE  source in ( N'" & Me.Name & "', N'frmPaymentNew')  " & IIf(PreviouseRecordShow = True, "", " AND (Convert(varchar, voucher_date,102) > Convert(Datetime, N'" & ClosingDate & "',102))") & ""
                'End Task#04082015
        ...
        Try
            ...
            Try
                ...
                For Each r As Janus.Windows.GridEX.GridEXRow In Me.grd.GetRows
                    ...
                    '                    'End If
                    '                    'strMSGBody += " have been paid through " & IIf(Me.cmbVoucherType.Text = "Bank", "Bank", "Cash") & ". thanks for your cooperation. Automated by www.SIRIUS.net"
...
& " Where voucher_id =" & VoucherID & "AND (tblVoucherDetail.debit_amount > 0) Order By tblVoucherDetail.Voucher_Detail_Id ASC "
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frmVendorPayment_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
            ...
            'short key for search in history added by zainab ctrl+F
            If e.KeyCode = Keys.F AndAlso e.Control Then
                btnSearchDocument_Click(Nothing, Nothing)
            End If
            'Edit
        ...
        End Try
    End Sub
    Private Sub frmVendorPayment_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
    ...
    Private Sub ToolStripComboBox1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ToolStripComboBox1.SelectedIndexChanged
        Try
            ...
            If Me.ToolStripComboBox1.SelectedIndex = 0 Then
                ...
                str = "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1  " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & ""
                ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                'If LoginGroup = "Administrator" Then ''Commented against TFS4689
                If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then
                    str = "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1 "
            ...
            ElseIf Me.ToolStripComboBox1.SelectedIndex = 1 Then
                ...
                ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                ' If LoginGroup = "Administrator" Then
                If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then ''TFS4689
                    str = "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1 "
                    str += " And (coa_detail_id in (Select COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 3) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                           & " or main_sub_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 2) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                           & " or main_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 1) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                ...
                ''Commented Against TFS3322
                'FillUltraDropDown(Me.cmbAccounts, "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1  " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & "  order by 2")
                FillUltraDropDown(Me.cmbAccounts, str) ''TFS3322
        ...
        Try
            ...
            If blnEditMode = False Then
                If Me.chkAllAccounts.Checked = True Then
                    str = "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1  " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & "  "
                    ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                    ' If LoginGroup = "Administrator" Then
                    If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then
                        str = "select coa_detail_id, detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c], vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id  where detail_title is not null AND vwCOADetail.Active=1 "
                        str += " And (coa_detail_id in (Select COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 3) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or main_sub_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 2) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or main_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 1) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or coa_main_id in (SELECT   COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 0) and COAUserMapping.[User_Id]= " & LoginGroupId & ")) "
                    ...
                    End If
                Else
                    str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null  AND vwCOADetail.Account_Type='Vendor' And vwCOADetail.Active=1 " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & " "
                    ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                    ' If LoginGroup = "Administrator" Then
                    If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then
                        str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null AND vwCOADetail.Active=1 "
            ...
            Else
                If Me.chkAllAccounts.Checked = True Then
                    str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail  LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & " "
                    ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                    ' If LoginGroup = "Administrator" Then
                    If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then
                        str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail  LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null  "
                        str += " And (coa_detail_id in (Select COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 3) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or main_sub_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 2) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or main_sub_id in (SELECT COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 1) and COAUserMapping.[User_Id]= " & LoginGroupId & " ) " _
                               & " or coa_main_id in (SELECT   COAAccountMapping.AccountId FROM COAAccountMapping INNER JOIN COAGroups ON COAAccountMapping.COAGroupId = COAGroups.COAGroupId INNER JOIN COAUserMapping ON COAGroups.COAGroupId = COAUserMapping.COAGroupId WHERE (COAAccountMapping.AccountLevel = 0) and COAUserMapping.[User_Id]= " & LoginGroupId & ")) "
                ...
                Else
                    ...
                    str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail  LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null AND Account_Type='Vendor' " & IIf(flgCompanyRights = True, " AND vwCOADetail.CompanyId=" & MyCompanyId & "", "") & " "
                    ''Start TFS3322 : Ayesha Rehman : 15-05-2018
                    'If LoginGroup = "Administrator" Then
                    If GetMappedUserId() > 0 And getGroupAccountsConfigforAccounts(Me.Name) And LoginGroup <> "Administrator" Then
                        str = "select coa_detail_id,detail_title,detail_code, dbo.vwCOADetail.sub_sub_title AS [Sub Sub A/c],vwCoaDetail.Contact_Phone as Phone, dbo.vwCoaDetail.Contact_Mobile as Mobile, Ven.PayeeTitle, Account_Type as Type, Isnull(vwCOADetail.AccessLevel,'Everyone') as AccessLevel  from vwCoaDetail  LEFT OUTER JOIN tblVendor Ven On Ven.AccountId = vwCOADetail.coa_detail_id where detail_title is not null "
    ...
    Public Sub ApplyGridSettings(Optional ByVal Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            ...
            Me.grd.RootTable.Columns(grdEnm.TaxAmount).FormatString = "N" & TotalAmountRounding
            ...
            If IsEmailAlert = True Then
                ...
                If flg = True Then
                    If AdminEmail <> "" Then
                        ...
                        & " " & IIf(setEditMode = False, "of amount " & Total_Amount & " is made", "of amount " & Prviouse_Amount & " is updated to " & Total_Amount & "") & " by user " & LoginUserName & " " & vbCrLf & " " & vbCrLf & " " & vbCrLf & " " & vbCrLf & " " & vbCrLf & " " & vbCrLf & " " & vbCrLf & "Auto Generated By SIRIUS ERP System"
...
#End Region
    ...
    Private Sub btnNewPayment_Click(sender As Object, e As EventArgs) Handles btnNewPayment.Click
        Try
            SaveConfiguration("NewPaymentForm", "True")
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub txtPaymentBeforeBalance_TextChanged(sender As Object, e As EventArgs) Handles txtPaymentBeforeBalance.TextChanged


        Try
            If Me.txtPaymentBeforeBalance.Text = "" Then
                lblCashBalncNumberConvertor.Text = ""
            Else
                lblCashBalncNumberConvertor.Text = ModGlobel.NumberToWords(Me.txtPaymentBeforeBalance.Text)
            End If
    ...
    Private Sub CtrlGrdBar4_Load(sender As Object, e As EventArgs) Handles CtrlGrdBar4.Load
        Try
            If IO.File.Exists(Application.ExecutablePath & "\..\Layouts\" & Me.Name & "_" & Me.grd.Name) Then
                ...
                fs.Dispose()
            End If
            Me.CtrlGrdBar4.txtGridTitle.Text = CompanyTitle & Chr(10) & " Payments "
    ...
    Private Sub CtrlGrdBar2_Load(sender As Object, e As EventArgs) Handles CtrlGrdBar2.Load
        Try
            If IO.File.Exists(Application.ExecutablePath & "\..\Layouts\" & Me.Name & "_" & Me.grdVouchers.Name) Then
                ...
                fs.Dispose()
            End If
            Me.CtrlGrdBar2.txtGridTitle.Text = CompanyTitle & Chr(10) & " Payments "
    ...
    Private Sub frmVendorPayment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
