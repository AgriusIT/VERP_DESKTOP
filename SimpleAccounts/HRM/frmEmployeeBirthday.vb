'Ali Faisal : TFS1840 : Add report to show the list of those employees who's birthdays in give date range
Imports System
Imports SBDal
Imports SBModel
Imports SBUtility
Public Class frmEmployeeBirthday
    Implements IGeneral
    Dim _SearchDt As New DataTable
    Dim FromDate As DateTime
    Dim ToDate As DateTime
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Set indexing of Records grid
    ''' </summary>
    ''' <remarks></remarks>
    Enum grd
        EmployeeId
    ...
    End Enum
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Apply grid settings to hide some columns and formating too
    ''' </summary>
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            ...
            Me.grdSaved.RootTable.Columns(grd.DOB).FormatString = str_DisplayDateFormat
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Apply security to show specific controls to standard users
    ''' </summary>
    ...
    End Function
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Fill list bosex
    ''' </summary>
    ''' <param name="Condition"></param>
    ''' <remarks></remarks>
    ...
    End Sub
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Get all records to get data in given duration
    ''' </summary>
    ''' <param name="Condition"></param>
    ''' <remarks></remarks>
    Public Sub GetAllRecords(Optional Condition As String = "") Implements IGeneral.GetAllRecords
        Try
            ...
            str = "SELECT tblDefEmployee.Employee_ID AS EmployeeId, tblDefEmployee.Employee_Code AS [Emp Code], tblDefEmployee.Employee_Name AS [Emp Name], tblDefEmployee.Dept_ID AS DepartmentId, EmployeeDeptDefTable.EmployeeDeptName AS Department, tblDefEmployee.Desig_ID AS DesignationId, EmployeeDesignationDefTable.EmployeeDesignationName AS Designation, tblDefEmployee.CostCentre AS CostCenterId, tblDefCostCenter.Name AS [Cost Center], tblDefEmployee.ShiftGroupId, tblDefEmployee.City_ID AS CityId, tblDefCostCenter.CostCenterGroup,tblDefEmployee.DOB " _
                ...
                & "WHERE tblDefEmployee.Active = 1 AND LEFT(tblDefEmployee.DOB,6) BETWEEN '" & FromDate.ToString("MMM ") & "' AND '" & ToDate.ToString("MMM dd") & "'"
    ...
    End Function
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Reset all controls to their default values
    ''' </summary>
    ''' <param name="Condition"></param>
    ''' <remarks></remarks>
    ...
    Private Sub cmbPeriod_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbPeriod.SelectedIndexChanged
        If Me.cmbPeriod.Text = "January" Then
            FromDate = "Jan 01"
            ToDate = "Jan 31"
        ElseIf Me.cmbPeriod.Text = "February" Then
            FromDate = "Feb 01"
            ToDate = "Feb 28"
        ElseIf Me.cmbPeriod.Text = "March" Then
            FromDate = "Mar 01"
            ToDate = "Mar 31"
        ElseIf Me.cmbPeriod.Text = "April" Then
            FromDate = "Apr 01"
            ToDate = "Apr 30"
        ElseIf Me.cmbPeriod.Text = "May" Then
            FromDate = "May 01"
            ToDate = "May 31"
        ElseIf Me.cmbPeriod.Text = "June" Then
            FromDate = "Jun 01"
            ToDate = "Jun 30"
        ElseIf Me.cmbPeriod.Text = "July" Then
            FromDate = "Jul 01"
            ToDate = "Jul 31"
        ElseIf Me.cmbPeriod.Text = "August" Then
            FromDate = "Aug 01"
            ToDate = "Aug 31"
        ElseIf Me.cmbPeriod.Text = "September" Then
            FromDate = "Sep 01"
            ToDate = "Sep 30"
        ElseIf Me.cmbPeriod.Text = "October" Then
            FromDate = "Oct 01"
            ToDate = "Oct 31"
        ElseIf Me.cmbPeriod.Text = "November" Then
            FromDate = "Nov 01"
            ToDate = "Nov 30"
        ElseIf Me.cmbPeriod.Text = "December" Then
            FromDate = "Dec 01"
            ToDate = "Dec 31"
        End If
    End Sub
    Private Sub CtrlGrdBar1_Load(sender As Object, e As EventArgs) Handles CtrlGrdBar1.Load
        Try
            If IO.File.Exists(Application.ExecutablePath & "\..\Layouts\" & Me.Name & "_" & Me.grdSaved.Name) Then
                ...
                fs.Dispose()
            End If
            Me.CtrlGrdBar1.txtGridTitle.Text = CompanyTitle & Chr(10) & "Employee Birthdays Report"
        Catch ex As Exception
    ...
    End Sub
    ''' <summary>
    ''' Ali Faisal : TFS1840 : Show crystal report
    ''' </summary>
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            ShowReport("rptEmployeeBirthdays")
        Catch ex As Exception
            ShowErrorMessage(ex.Message)
        Finally
            Me.Cursor = Cursors.Default
