...
Public Class frmProPurchaseList
    Implements IGeneral
    Dim Purchase As PropertyPurchaseBE
    Dim objDAL As PropertyPurchaseDAL
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            Me.grd.RootTable.Columns("PropertyPurchaseId").Visible = False
            Me.grd.RootTable.Columns("SellerAccountId").Visible = False
    ...
    Public Sub ApplySecurity(Mode As SBUtility.Utility.EnumDataMode, Optional Condition As String = "") Implements IGeneral.ApplySecurity
        ...
        End Try
    End Sub
    Public Function Get_All(ByVal PurchaseNo As String)
        Try
            Get_All = Nothing
            If Not PurchaseNo.Length > 0 Then Exit Try
            If IsFormLoaded = True Then
                IsDrillDown = True
                Dim flag As Boolean = False
                flag = Me.grd.Find(Me.grd.RootTable.Columns("VoucherNo"), Janus.Windows.GridEX.ConditionOperator.Equal, (PurchaseNo).Trim, 0, 1)
    ...
    Public Sub GetAllRecords(Optional Condition As String = "") Implements IGeneral.GetAllRecords
        Try
            objDAL = New PropertyPurchaseDAL
    ...
    Private Sub btnAddDock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddDock.Click
        Try
            frmProPurchase.PPID = 0
            frmProPurchase.EditAble = 0
            frmProPurchase.DoHaveSaveRights = DoHaveSaveRights
    ...
    Private Sub grd_DoubleClick(sender As Object, e As EventArgs) Handles grd.DoubleClick
        Try
            If Me.grd.RowCount > 0 Then
                frmProPurchase.PPID = Val(Me.grd.CurrentRow.Cells("PropertyPurchaseId").Value.ToString)
                frmProPurchase.DoHaveUpdateRights = DoHaveUpdateRights
            Else
                frmProPurchase.PPID = 0
            End If
            frmProPurchase.ShowDialog()
    ...
    Private Sub grd_ColumnButtonClick(sender As Object, e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grd.ColumnButtonClick
        Try
            ...
            Purchase.PurchaseId = Val(Me.grd.CurrentRow.Cells("PropertyPurchaseId").Value.ToString)
            If e.Column.Key = "Delete" Then
                If Not msg_Confirm(str_ConfirmDelete) = True Then Exit Sub
                If DoHaveDeleteRights = True Then
                    objDAL.Delete(Purchase)
    ...
    Private Sub frmProPurchaseList_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
