...
Public Class frmProItemList
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            ...
            Me.grd.RootTable.Columns("PropertyTypeId").Visible = False
            Me.grd.RootTable.Columns("TerritoryId").Visible = False
    ...
    Private Sub btnAddDock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddDock.Click
        Try
            frmProItem.ProItemId = 0
            frmProItem.ShowDialog()
            GetAllRecords()
        Catch ex As Exception
        ...
        Try
            ...
            If e.Column.Key = "Delete" Then
                If DeleteRight = True Then
                    ...
                    objDAL.Delete(Val(Me.grd.CurrentRow.Cells("PropertyItemId").Value.ToString))
    ...
    Private Sub grd_DoubleClick(sender As Object, e As EventArgs) Handles grd.DoubleClick
        Try
            If Me.grd.RowCount > 0 Then
                frmProItem.ProItemId = Val(Me.grd.CurrentRow.Cells("PropertyItemId").Value.ToString)
            Else
                frmProItem.ProItemId = 0
            End If
            frmProItem.ShowDialog()
    ...
    Private Sub CtrlGrdBar1_Load(sender As Object, e As EventArgs) Handles CtrlGrdBar1.Load
        Try
            If IO.File.Exists(Application.ExecutablePath & "\..\Layouts\" & Me.Name & "_" & Me.grd.Name) Then
                ...
                fs.Dispose()
            End If
            Me.CtrlGrdBar1.txtGridTitle.Text = CompanyTitle & Chr(10) & "Property Item Definition"
        Catch ex As Exception
            ShowErrorMessage(ex.Message)
        End Try
    End Sub

    Private Sub frmProItemList_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
