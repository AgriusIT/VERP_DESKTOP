'Imports DAL
Public Class frmCustomerDiscountsFlat
    Implements IGeneral
        ...
        Try
            ...
            For Each r As DataRow In dt.Rows
                If Not dt.Columns.Contains(r.Item(1)) Then
                    ...
                    dtMain.Columns.Add(r(0), GetType(System.Int32), r(0))
                    dtMain.Columns.Add(r(1), GetType(System.Double))
                End If
            Next
    ...
    Public Sub GetAllRecords(Optional ByVal Condition As String = "") Implements IGeneral.GetAllRecords
        Try
            Dim strsql As String = "Select * from tbldefcustomerbasediscountsFlat"
            Dim dt As DataTable = GetDataTable(strsql)
    ...
    Public Function Save(Optional ByVal Condition As String = "") As Boolean Implements IGeneral.Save
        ...
        Try
            ...
            Dim strSQL As String = String.Empty
            'strSQL = "delete from tbldefcustomerbasediscountsFlat"
            ...
            '        strSQL = "delete from tbldefcustomerbasediscountsFlat where articledefid = " & r.Cells(EnumGrid.ID).Value _
            '        & " and typeid = " & r.Cells(c).Value
            '        cmd.CommandText = strSQL
            '        cmd.ExecuteNonQuery()

            '        strSQL = "insert into tbldefcustomerbasediscountsFlat (articledefid, typeid , discount) " _
            ...
            For Each r As DataRow In dtGrid.Rows
                For c As Int32 = EnmGrid.Count To Me.grdDiscounts.RootTable.Columns.Count - 2 Step 2
                    'cmd.CommandText = ""
                    'strSQL = "delete from tbldefcustomerbasediscountsFlat where articledefid = " & Val(r(EnumGrid.ID)) _
                    '& " and typeid = " & r(c)
                    'cmd.CommandText = strSQL
                    'cmd.ExecuteNonQuery()
                    ...
                    cmd.CommandText = ""
                    strSQL = "delete from tbldefcustomerbasediscountsFlat where articledefid = " & Val(r(EnmGrid.ArticleId)) _
                    & " and typeid = " & r(c)
                    cmd.CommandText = strSQL
                    cmd.ExecuteNonQuery()
