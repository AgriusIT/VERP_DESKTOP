...
Public Class frmCity
    ...
    Dim objModel As CityBE
    Dim objDAL As CityDAL
    ...
    End Sub
    Private Sub DataGridView1_FormattingRow(sender As Object, e As Janus.Windows.GridEX.RowLoadEventArgs)

    End Sub
    ''Saba Shabbir: it will open a new form for entering new record of vehicle
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        frmAddCity.DoHaveSaveRights = DoHaveSaveRights
        frmAddCity.blnEditMode = False
    ...
    Private Sub DataGridView1_RowDoubleClick(sender As Object, e As Janus.Windows.GridEX.RowActionEventArgs) Handles DataGridView1.RowDoubleClick
        ...
        Try
            If Me.DataGridView1.RowCount > 0 AndAlso DataGridView1.GetRow.RowType = Janus.Windows.GridEX.RowType.Record Then
                ...
                frmAddCity.IdOfCity = Val(Me.DataGridView1.CurrentRow.Cells("CityId").Value.ToString)
                frmAddCity.DoHaveUpdateRights = DoHaveUpdateRights
                frmAddCity.blnEditMode = True
                frmAddCity.ShowDialog()
                GetAllRecords()
            End If
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            'CityId, CityName, StateId, SortOrder, Comments, Active, IsDate, BeltId from tblListCity  "
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        Try
            objModel = New CityBE
            objDAL = New CityDAL
            CityId = Val(Me.DataGridView1.CurrentRow.Cells("CityId").Value.ToString)
            objModel.CityId = CityId
        ...
        End Try
    End Sub
    Private Sub frmCity_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
