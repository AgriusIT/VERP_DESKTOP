...
Public Class frmFinishGoodStandardDialog
    ...
    End Sub
    Public Sub New(ByVal FinishGood As BEFinishGood)
        ' This call is required by the designer.
        InitializeComponent()
        ' Add any initialization after the InitializeComponent() call.
        Me.FinishGoodId = FinishGoodId
    ...
    Public Sub EditRecord(Optional ByVal Condition As String = "")
        ...
        End Try
    End Sub
    Public Sub EditRecord(ByVal Obj As BEFinishGood)
        Try
            Me.btnSave.Text = "&Update"
            FinishGoodId = Obj.Id
            Me.cmbMasterItem.Value = Obj.MasterArticleId
            Me.txtStandardNo.Text = Obj.StandardNo
            Me.txtVersion.Text = Obj.Version
            Me.txtStandardName.Text = Obj.StandardName
            Me.txtBatchSize.Text = Obj.BatchSize
            Me.cbDefault.Checked = Obj.Default1
            Me.GetDetail(FinishGoodId)
            Me.GetFinishGoodOverHeads(FinishGoodId)
            Me.GetFinishGoodByProducts(FinishGoodId)
            Me.GetFinishGoodLabourAllocation(FinishGoodId)
