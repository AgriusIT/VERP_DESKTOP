...
Public Class LedgerIndividual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.LedgerIndividual.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedLedgerIndividual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerIndividual = New LedgerIndividual()
        rpt.Site = Me.Site
        Return rpt
    End Function
