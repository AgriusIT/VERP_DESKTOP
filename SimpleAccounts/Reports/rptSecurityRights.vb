...
Public Class rptSecurityRights
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptSecurityRights.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSecurityRights
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSecurityRights = New rptSecurityRights()
        rpt.Site = Me.Site
        Return rpt
    End Function
