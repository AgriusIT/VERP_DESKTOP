...
Public Class rptGoodReceived
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptGoodReceived.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGoodReceived
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGoodReceived = New rptGoodReceived()
        rpt.Site = Me.Site
        Return rpt
    End Function
