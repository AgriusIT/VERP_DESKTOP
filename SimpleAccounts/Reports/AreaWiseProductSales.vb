...
Public Class AreaWiseProductSales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AreaWiseProductSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.AreaWiseProductSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAreaWiseProductSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AreaWiseProductSales = New AreaWiseProductSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
