...
Public Class RptWarentyClaim
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptWarentyClaim.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptWarentyClaim
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptWarentyClaim = New RptWarentyClaim()
        rpt.Site = Me.Site
        Return rpt
    End Function
