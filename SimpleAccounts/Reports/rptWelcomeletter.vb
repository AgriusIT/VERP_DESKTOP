...
Public Class rptWelcomeletter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptWelcomeletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWelcomeletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWelcomeletter = New rptWelcomeletter()
        rpt.Site = Me.Site
        Return rpt
    End Function
