...
Public Class rptoutwardgatepass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptoutwardgatepass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutwardgatepass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutwardgatepass = New rptoutwardgatepass()
        rpt.Site = Me.Site
        Return rpt
    End Function
