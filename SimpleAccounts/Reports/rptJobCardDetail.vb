...
Public Class rptJobCardDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptJobCardDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobCardDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobCardDetail = New rptJobCardDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
