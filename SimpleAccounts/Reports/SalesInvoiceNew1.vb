...
Public Class SalesInvoiceNew1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.SalesInvoiceNew1.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_SaleID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSalesInvoiceNew1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesInvoiceNew1 = New SalesInvoiceNew1()
        rpt.Site = Me.Site
        Return rpt
    End Function
