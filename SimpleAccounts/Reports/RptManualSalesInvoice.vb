...
Public Class RptManualSalesInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptManualSalesInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptManualSalesInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CertificateId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptManualSalesInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptManualSalesInvoice = New RptManualSalesInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
