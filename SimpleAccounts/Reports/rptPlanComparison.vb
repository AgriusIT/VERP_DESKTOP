...
Public Class rptPlanComparison
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptPlanComparison.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanComparison
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanComparison = New rptPlanComparison()
        rpt.Site = Me.Site
        Return rpt
    End Function
