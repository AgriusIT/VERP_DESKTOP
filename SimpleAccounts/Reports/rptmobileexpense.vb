...
Public Class rptmobileexpense
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptmobileexpense.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptmobileexpense
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptmobileexpense = New rptmobileexpense()
        rpt.Site = Me.Site
        Return rpt
    End Function
