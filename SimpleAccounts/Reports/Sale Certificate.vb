...
Public Class Sale_Certificate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.Sale Certificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSale_Certificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sale_Certificate = New Sale_Certificate()
        rpt.Site = Me.Site
        Return rpt
    End Function
