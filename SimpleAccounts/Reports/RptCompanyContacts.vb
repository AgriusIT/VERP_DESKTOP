...
Public Class RptCompanyContacts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptCompanyContacts.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ReferenceID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCompanyContacts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCompanyContacts = New RptCompanyContacts()
        rpt.Site = Me.Site
        Return rpt
    End Function
