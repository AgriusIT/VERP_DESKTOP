...
Public Class rptExpenseStatment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptExpenseStatment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExpenseStatment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExpenseStatment = New rptExpenseStatment()
        rpt.Site = Me.Site
        Return rpt
    End Function
