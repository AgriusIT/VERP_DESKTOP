...
Public Class rptQuotationNew1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptQuotationNew1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQuotationNew1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQuotationNew1 = New rptQuotationNew1()
        rpt.Site = Me.Site
        Return rpt
    End Function
