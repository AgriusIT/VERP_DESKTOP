...
Public Class rptImportDocument
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptImportDocument.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_LCDocId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptImportDocument
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImportDocument = New rptImportDocument()
        rpt.Site = Me.Site
        Return rpt
    End Function
