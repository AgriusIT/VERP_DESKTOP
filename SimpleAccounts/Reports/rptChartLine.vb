...
Public Class rptChartLine
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptChartLine.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChartLine
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChartLine = New rptChartLine()
        rpt.Site = Me.Site
        Return rpt
    End Function
