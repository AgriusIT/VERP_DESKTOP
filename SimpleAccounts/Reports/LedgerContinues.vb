...
Public Class LedgerContinues
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.LedgerContinues.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerContinues
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerContinues = New LedgerContinues()
        rpt.Site = Me.Site
        Return rpt
    End Function
