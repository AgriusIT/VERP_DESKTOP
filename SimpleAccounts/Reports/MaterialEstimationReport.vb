...
Public Class MaterialEstimationReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MaterialEstimationReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.MaterialEstimationReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PlanTicketsMasterID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMaterialEstimationReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MaterialEstimationReport = New MaterialEstimationReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
