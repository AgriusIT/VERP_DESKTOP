...
Public Class RptCmfaDocument
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptCmfaDocument.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCmfaDocument
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCmfaDocument = New RptCmfaDocument()
        rpt.Site = Me.Site
        Return rpt
    End Function
