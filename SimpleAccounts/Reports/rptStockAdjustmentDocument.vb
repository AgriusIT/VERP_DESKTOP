...
Public Class rptStockAdjustmentDocument
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockAdjustmentDocument.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptStockAdjustmentDocument.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SA_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockAdjustmentDocument
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockAdjustmentDocument = New rptStockAdjustmentDocument()
        rpt.Site = Me.Site
        Return rpt
    End Function
