Imports SBModel
Public Class frmLiftWiseBusinessReport
    ...
    Public Sub GetRecord()
        Try
            ...
            ElseIf Me.dtpInquiryFromDate.Checked = True AndAlso Me.dtpInquiryToDate.Checked = True Then
                IsBothChecked = 1
            End If
            Dim dt As DataTable = GetDataTable("Exec SP_LiftWiseBusiness '" & dtpInquiryFromDate.Value & "', '" & dtpInquiryToDate.Value & "', " & IsOneChecked & ", " & IsTwoChecked & ", " & IsBothChecked & "")
            dt.AcceptChanges()
    ...
    Private Sub PrintReport()
        Try
            ...
            ShowReport("rptLiftWiseBusiness")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

    Private Sub frmLiftWiseBusinessReport_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            GetSecurityRights()
        Catch ex As Exception
            ShowErrorMessage(ex.Message)
