...
Public Class frmLiftWiseDetailReport
    ...
    Public Sub GetRecord()
        Try
            ...
            ElseIf Me.dtpInquiryFromDate.Checked = True AndAlso Me.dtpInquiryToDate.Checked = True Then
                IsBothChecked = 1
            End If
            Dim dt As DataTable = GetDataTable("Exec SP_LiftWiseDetail '" & dtpInquiryFromDate.Value & "', '" & dtpInquiryToDate.Value & "', " & IsOneChecked & ", " & IsTwoChecked & ", " & IsBothChecked & "," & Me.cmbLabour.SelectedValue & "")
            dt.AcceptChanges()
    ...
    Private Sub PrintReport()
        Try
            ...
            AddRptParam("@ArticleId", Me.cmbLabour.SelectedValue)
    ...
    Private Sub frmLiftWiseDetailReport_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            GetSecurityRights()
            FillDropDown(Me.cmbLabour, "select ArticleId , ArticleDescription from ArticleDefTableMaster where ArticleGroupId = 2", True)
        Catch ex As Exception
        End Try
    End Sub
End Class