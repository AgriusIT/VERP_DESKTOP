...
Public Class RptVoucherDocument
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptVoucherDocument.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVoucherDocument
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVoucherDocument = New RptVoucherDocument()
        rpt.Site = Me.Site
        Return rpt
    End Function
