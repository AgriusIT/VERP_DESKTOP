...
Imports SBModel
Public Class SummaryofSalesAndReturns
    Public flgCompanyRights As Boolean = False
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Show button to display the crystal report
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>'Ali Faisal : TFS1370 : 24-Aug-2017 : </remarks>
    ...
    End Sub
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Get the Procedure from database and apply all filters values to show report
    ''' </summary>
            ...
            If cmbCustomer.Visible = True Then
                If Me.pnlSalesType.Visible = True Then
                    If Me.rbtSalesTypeBoth.Checked = True Then
                        strInvoiceTypeFilter += " AND {SP_SummarOfSalesAndReturns;1.InvoiceType} in ['Cash', 'Credit','']"
                    ElseIf Me.rbtCreditSales.Checked = True Then
                        strInvoiceTypeFilter += " AND {SP_SummarOfSalesAndReturns;1.InvoiceType} = 'Credit'"
                    ElseIf Me.rbtCashSales.Checked = True Then
                        strInvoiceTypeFilter += " AND {SP_SummarOfSalesAndReturns;1.InvoiceType} = 'Cash'"
                    End If
                End If
                If Me.cmbCustomer.ActiveRow.Cells(0).Value > 0 Then
                    If CostCentre > 0 Then
                        ShowReport("SummaryOfSalesAndReturn", "{SP_SummarOfSalesAndReturns;1.DocDate} in DateTime (" & fromDate & ") to DateTime (" & ToDate & ") " & strInvoiceTypeFilter & " AND {SP_SummarOfSalesAndReturns;1.CostCenterID} =" & CostCentre & "  AND {SP_SummarOfSalesAndReturns;1.CustomerCode} =" & Me.cmbCustomer.Value & IIf(Me.cmbCompany.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.LocationId} =" & Me.cmbCompany.SelectedValue & "", "") & " " & IIf(Me.cmbCustomerType.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CustomerTypeID} =" & Me.cmbCustomerType.SelectedValue & "", "") & IIf(Me.cmbState.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.StateID} =" & Me.cmbState.SelectedValue & "", "") & IIf(Me.cmbRegion.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.RegionID} =" & Me.cmbRegion.SelectedValue & "", "") & IIf(Me.cmbZone.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.ZoneID} =" & Me.cmbZone.SelectedValue & "", "") & IIf(Me.cmbBelt.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.BeltID} =" & Me.cmbBelt.SelectedValue & "", "") & IIf(Me.cmbCity.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CityID} =" & Me.cmbCity.SelectedValue & "", ""), Me.DateTimePicker1.Text, Me.DateTimePicker2.Text, Print)
                    Else
                        ShowReport("SummaryOfSalesAndReturn", "{SP_SummarOfSalesAndReturns;1.DocDate} in DateTime (" & fromDate & ") to DateTime (" & ToDate & ") " & strInvoiceTypeFilter & "  AND {SP_SummarOfSalesAndReturns;1.CustomerCode} =" & Me.cmbCustomer.Value & IIf(Me.cmbCompany.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.LocationId} =" & Me.cmbCompany.SelectedValue & "", "") & " " & IIf(Me.cmbCustomerType.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CustomerTypeID} =" & Me.cmbCustomerType.SelectedValue & "", "") & IIf(Me.cmbState.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.StateID} =" & Me.cmbState.SelectedValue & "", "") & IIf(Me.cmbRegion.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.RegionID} =" & Me.cmbRegion.SelectedValue & "", "") & IIf(Me.cmbZone.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.ZoneID} =" & Me.cmbZone.SelectedValue & "", "") & IIf(Me.cmbBelt.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.BeltID} =" & Me.cmbBelt.SelectedValue & "", "") & IIf(Me.cmbCity.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CityID} =" & Me.cmbCity.SelectedValue & "", ""), Me.DateTimePicker1.Text, Me.DateTimePicker2.Text, Print)
                    End If
                Else
                    If CostCentre > 0 Then
                        ShowReport("SummaryOfSalesAndReturn", "{SP_SummarOfSalesAndReturns;1.DocDate} in DateTime (" & fromDate & ") to DateTime (" & ToDate & ") AND {SP_SummarOfSalesAndReturns;1.CostCenterID} =" & CostCentre & " " & strInvoiceTypeFilter & " " & IIf(Me.cmbCompany.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.LocationId} =" & Me.cmbCompany.SelectedValue & "", "") & " " & IIf(Me.cmbCustomerType.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CustomerTypeID} =" & Me.cmbCustomerType.SelectedValue & "", "") & IIf(Me.cmbState.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.StateID} =" & Me.cmbState.SelectedValue & "", "") & IIf(Me.cmbRegion.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.RegionID} =" & Me.cmbRegion.SelectedValue & "", "") & IIf(Me.cmbZone.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.ZoneID} =" & Me.cmbZone.SelectedValue & "", "") & IIf(Me.cmbBelt.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.BeltID} =" & Me.cmbBelt.SelectedValue & "", "") & IIf(Me.cmbCity.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CityID} =" & Me.cmbCity.SelectedValue & "", ""), Me.DateTimePicker1.Text, Me.DateTimePicker2.Text, Print)
                    Else
                        ShowReport("SummaryOfSalesAndReturn", "{SP_SummarOfSalesAndReturns;1.DocDate} in DateTime (" & fromDate & ") to DateTime (" & ToDate & ") " & strInvoiceTypeFilter & " " & IIf(Me.cmbCompany.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.LocationId} =" & Me.cmbCompany.SelectedValue & "", "") & " " & IIf(Me.cmbCustomerType.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CustomerTypeID} =" & Me.cmbCustomerType.SelectedValue & "", "") & IIf(Me.cmbState.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.StateID} =" & Me.cmbState.SelectedValue & "", "") & IIf(Me.cmbRegion.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.RegionID} =" & Me.cmbRegion.SelectedValue & "", "") & IIf(Me.cmbZone.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.ZoneID} =" & Me.cmbZone.SelectedValue & "", "") & IIf(Me.cmbBelt.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.BeltID} =" & Me.cmbBelt.SelectedValue & "", "") & IIf(Me.cmbCity.SelectedIndex > 0, " AND {SP_SummarOfSalesAndReturns;1.CityID} =" & Me.cmbCity.SelectedValue & "", ""), Me.DateTimePicker1.Text, Me.DateTimePicker2.Text, Print)
                    End If
                End If
            Else
                If CostCentre > 0 Then
    ...
    End Sub
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Fast print of crystal report
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>'Ali Faisal : TFS1370 : 24-Aug-2017 : </remarks>
    ...
    End Sub
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Period selection for date range
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>'Ali Faisal : TFS1370 : 24-Aug-2017 : </remarks>
    ...
    End Sub
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Load form
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>'Ali Faisal : TFS1370 : 24-Aug-2017 : </remarks>
    ...
    End Sub
    ''' <summary>
    ''' 'Ali Faisal : TFS1370 : 24-Aug-2017 : Get security rights for standard user
    ''' </summary>
    ''' <remarks>'Ali Faisal : TFS1370 : 24-Aug-2017 : </remarks>
