...
Public Class DeliveryChalanNew1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.DeliveryChalanNew1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DeliveryID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDeliveryChalanNew1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryChalanNew1 = New DeliveryChalanNew1()
        rpt.Site = Me.Site
        Return rpt
    End Function
