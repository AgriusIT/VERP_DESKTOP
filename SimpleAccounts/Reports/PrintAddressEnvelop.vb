...
Public Class PrintAddressEnvelop
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrintAddressEnvelop.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.PrintAddressEnvelop.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SalesId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPrintAddressEnvelop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintAddressEnvelop = New PrintAddressEnvelop()
        rpt.Site = Me.Site
        Return rpt
    End Function
