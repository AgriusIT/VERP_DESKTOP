...
Public Class SummaryOfInvoices
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.SummaryOfInvoices.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSummaryOfInvoices
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SummaryOfInvoices = New SummaryOfInvoices()
        rpt.Site = Me.Site
        Return rpt
    End Function
