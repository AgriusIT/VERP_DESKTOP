...
Public Class rptStockStatment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptStockStatment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockStatment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockStatment = New rptStockStatment()
        rpt.Site = Me.Site
        Return rpt
    End Function
