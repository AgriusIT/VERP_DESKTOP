...
Public Class SalesOrderNew2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.SalesOrderNew2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesOrderNew2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesOrderNew2 = New SalesOrderNew2()
        rpt.Site = Me.Site
        Return rpt
    End Function
