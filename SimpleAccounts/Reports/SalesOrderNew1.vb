...
Public Class SalesOrderNew1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.SalesOrderNew1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesOrderNew1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesOrderNew1 = New SalesOrderNew1()
        rpt.Site = Me.Site
        Return rpt
    End Function
