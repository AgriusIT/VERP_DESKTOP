...
Public Class rptDailySalaryVoucher
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDailySalaryVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptDailySalaryVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CurrentId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDailySalaryVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailySalaryVoucher = New rptDailySalaryVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
