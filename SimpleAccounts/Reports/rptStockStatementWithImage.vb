...
Public Class rptStockStatementWithImage
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockStatementWithImage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptStockStatementWithImage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CompanyHeader() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockStatementWithImage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockStatementWithImage = New rptStockStatementWithImage()
        rpt.Site = Me.Site
        Return rpt
    End Function
