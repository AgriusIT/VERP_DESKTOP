...
Public Class rptAdvancePayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptAdvancePayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdvancePayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdvancePayments = New rptAdvancePayments()
        rpt.Site = Me.Site
        Return rpt
    End Function
