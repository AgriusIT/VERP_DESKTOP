...
Public Class rptAgreement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptAgreement.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AgreementId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAgreement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAgreement = New rptAgreement()
        rpt.Site = Me.Site
        Return rpt
    End Function
