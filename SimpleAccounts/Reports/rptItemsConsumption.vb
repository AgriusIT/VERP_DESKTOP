...
Public Class rptItemsConsumption
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptItemsConsumption.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptItemsConsumption.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ConsumptionId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptItemsConsumption
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptItemsConsumption = New rptItemsConsumption()
        rpt.Site = Me.Site
        Return rpt
    End Function
