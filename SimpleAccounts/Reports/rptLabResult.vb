...
Public Class rptLabResult
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptLabResult.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ResultId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptLabResult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLabResult = New rptLabResult()
        rpt.Site = Me.Site
        Return rpt
    End Function
