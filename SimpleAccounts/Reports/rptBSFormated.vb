...
Public Class rptBSFormated
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptBSFormated.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBSFormated
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBSFormated = New rptBSFormated()
        rpt.Site = Me.Site
        Return rpt
    End Function
