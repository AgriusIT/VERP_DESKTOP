...
Public Class rptVendors_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptVendors_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVendors_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVendors_List = New rptVendors_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
