...
Public Class rptProductionStore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptProductionStore.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ProductionId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProductionStore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionStore = New rptProductionStore()
        rpt.Site = Me.Site
        Return rpt
    End Function
