...
Public Class rptDispatchStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptDispatchStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDispatchStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDispatchStatus = New rptDispatchStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
