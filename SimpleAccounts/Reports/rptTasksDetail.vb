...
Public Class rptTasksDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptTasksDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTasksDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTasksDetail = New rptTasksDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
