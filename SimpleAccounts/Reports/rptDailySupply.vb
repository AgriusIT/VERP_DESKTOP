...
Public Class rptDailySupply
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptDailySupply.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailySupply
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailySupply = New rptDailySupply()
        rpt.Site = Me.Site
        Return rpt
    End Function
