...
Public Class rptMaterialPlan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptMaterialPlan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMaterialPlan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMaterialPlan = New rptMaterialPlan()
        rpt.Site = Me.Site
        Return rpt
    End Function
