...
Public Class rptCashRequest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptCashRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCashRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCashRequest = New rptCashRequest()
        rpt.Site = Me.Site
        Return rpt
    End Function
