...
Partial Class DailySalarySheetSummary
    ...
    Sub CallShowReport(Optional ByVal Print As Boolean = False)
        Try
            ...
            ShowReport("rptDailySalarySheetSummary") 'Task#1248 , IIf(Me.cmbCostCenter.SelectedIndex > 0, "{SP_DailySalarySummary.CostCenterId}=" & Me.cmbCostCenter.SelectedValue & IIf(Me.cmbEmployee.ActiveRow.Cells(0).Value > 0, " and  {SP_DailySalarySummary.EmployId}=" & Me.cmbEmployee.Value, ""), IIf(Me.cmbEmployee.ActiveRow.Cells(0).Value > 0, "{SP_DailySalarySummary.EmployId}=" & Me.cmbEmployee.Value, "Nothing")), Me.DateTimePicker1.Value.Date.ToString("dd/MMM/yyyy"), Me.DateTimePicker2.Value.Date.ToString("dd/MMM/yyyy"))
            ''End TFS3418
        Catch ex As Exception
            Throw ex
        Finally
