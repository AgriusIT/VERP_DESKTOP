...
Public Class rptAdvanceReceipts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptAdvanceReceipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdvanceReceipts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdvanceReceipts = New rptAdvanceReceipts()
        rpt.Site = Me.Site
        Return rpt
    End Function
