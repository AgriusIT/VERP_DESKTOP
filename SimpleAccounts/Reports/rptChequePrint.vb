...
Public Class rptChequePrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptChequePrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Account_Name() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptChequePrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChequePrint = New rptChequePrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
