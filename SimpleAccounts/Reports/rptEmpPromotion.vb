...
Public Class rptEmpPromotion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptEmpPromotion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpPromotion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpPromotion = New rptEmpPromotion()
        rpt.Site = Me.Site
        Return rpt
    End Function
