...
Public Class frmGrdSalesReturnDetail
    ...
    Public Sub FillGrid(Optional ByVal Condition As String = "")
        Try
            ...
            '------------------------------------------------------------- Transactions -----------------------------------------
            strSQL = "Select convert(varchar, CustomerCode) as CustomerCode, ArticleDefId, SUM(Isnull(Qty,0)) as Qty From SalesReturnMasterTable INNER JOIN SalesReturnDetailTable ON SalesReturnMasterTable.SalesReturnId = SalesReturnDetailTable.SalesReturnId LEFT OUTER JOIN CompanyDefTable On CompanyDefTable.CompanyId = SalesReturnMasterTable.LocationId WHERE (Convert(Varchar, SalesReturnMasterTable.SalesReturnDate, 102) BETWEEN Convert(Datetime, '" & Me.dtpFromDate.Value.ToString("yyyy-M-d 00:00:00") & "', 102) AND Convert(Datetime, '" & Me.dtpToDate.Value.ToString("yyyy-M-d 23:59:59") & "', 102)) " & IIf(Me.cmbCostCenter.SelectedIndex > 0, " AND  CompanyDefTable.CostCenterId=" & Me.cmbCostCenter.SelectedValue & "", "") & " Group By CustomerCode, ArticleDefId"
    ...
    Private Sub CtrlGrdBar1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CtrlGrdBar1.Load
        Try
            ...
            If IO.File.Exists(Application.ExecutablePath & "\..\Layouts\" & Me.Name & "_" & Me.grd.Name) Then
                ...
                fs.Close()
            End If
            Me.CtrlGrdBar1.txtGridTitle.Text = CompanyTitle & vbCrLf & "Return Detail" & vbCrLf & "Date From:" & dtpFromDate.ToString("dd-MMM-yyyy") & " Month: " & dtpToDate.ToString("dd-MMM-yyyy") & " "
