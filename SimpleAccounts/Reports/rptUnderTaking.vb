...
Public Class rptUnderTaking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptUnderTaking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptUnderTaking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptUnderTaking = New rptUnderTaking()
        rpt.Site = Me.Site
        Return rpt
    End Function
