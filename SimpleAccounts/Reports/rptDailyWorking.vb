...
Public Class rptDailyWorking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptDailyWorking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyWorking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyWorking = New rptDailyWorking()
        rpt.Site = Me.Site
        Return rpt
    End Function
