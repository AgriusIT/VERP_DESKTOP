...
Public Class rptAgreementLatter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptAgreementLatter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAgreementLatter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAgreementLatter = New rptAgreementLatter()
        rpt.Site = Me.Site
        Return rpt
    End Function
