...
Public Class rptBillEmbroidery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptBillEmbroidery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBillEmbroidery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBillEmbroidery = New rptBillEmbroidery()
        rpt.Site = Me.Site
        Return rpt
    End Function
