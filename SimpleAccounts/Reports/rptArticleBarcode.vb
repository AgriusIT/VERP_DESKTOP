...
Public Class rptArticleBarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptArticleBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArticleBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArticleBarcode = New rptArticleBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
