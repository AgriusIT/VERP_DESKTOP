...
Public Class rptSOStatusWithDC_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptSOStatusWithDC .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSOStatusWithDC_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSOStatusWithDC_ = New rptSOStatusWithDC_()
        rpt.Site = Me.Site
        Return rpt
    End Function
