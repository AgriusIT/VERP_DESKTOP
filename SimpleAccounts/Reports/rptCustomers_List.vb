...
Public Class rptCustomers_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptCustomers_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomers_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomers_List = New rptCustomers_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
