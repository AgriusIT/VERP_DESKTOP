...
Public Class crptInwardGatePass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.crptInwardGatePass.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_InwardGatePassId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrptInwardGatePass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptInwardGatePass = New crptInwardGatePass()
        rpt.Site = Me.Site
        Return rpt
    End Function
