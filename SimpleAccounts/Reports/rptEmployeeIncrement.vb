...
Public Class rptEmployeeIncrement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptEmployeeIncrement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployeeIncrement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployeeIncrement = New rptEmployeeIncrement()
        rpt.Site = Me.Site
        Return rpt
    End Function
