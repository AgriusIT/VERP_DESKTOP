...
Public Class SalesInvoiceNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.SalesInvoiceNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesInvoiceNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesInvoiceNew = New SalesInvoiceNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
