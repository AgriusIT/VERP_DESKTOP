...
Public Class rptEmployees_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptEmployees_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployees_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployees_List = New rptEmployees_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
