...
Public Class rptOutdoorDuty
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptOutdoorDuty.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOutdoorDuty
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOutdoorDuty = New rptOutdoorDuty()
        rpt.Site = Me.Site
        Return rpt
    End Function
