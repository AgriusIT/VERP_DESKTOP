...
Public Class rptJobCardSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptJobCardSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobCardSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobCardSummary = New rptJobCardSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
