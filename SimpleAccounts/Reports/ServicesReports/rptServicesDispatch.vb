...
Public Class rptServicesDispatch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptServicesDispatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptServicesDispatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptServicesDispatch = New rptServicesDispatch
        rpt.Site = Me.Site
        Return rpt
    End Function
