...
Public Class rptEmployeeTransferLetter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptEmployeeTransferLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployeeTransferLetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployeeTransferLetter = New rptEmployeeTransferLetter()
        rpt.Site = Me.Site
        Return rpt
    End Function
