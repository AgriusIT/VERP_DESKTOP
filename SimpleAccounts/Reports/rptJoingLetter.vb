...
Public Class rptJoingLetter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptJoingLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJoingLetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJoingLetter = New rptJoingLetter()
        rpt.Site = Me.Site
        Return rpt
    End Function
