...
Public Class rptResignation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.rptResignation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResignation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResignation = New rptResignation()
        rpt.Site = Me.Site
        Return rpt
    End Function
