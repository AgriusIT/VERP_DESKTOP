...
Public Class RptCMFADetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimpleAccounts.RptCMFADetail.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_rptCMFASalesInvSummary_Pm_SP_CMFADetail1DocId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCMFADetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCMFADetail = New RptCMFADetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
