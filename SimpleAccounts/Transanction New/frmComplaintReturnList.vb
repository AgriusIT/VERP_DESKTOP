...
Public Class frmComplaintReturnList

    Implements IGeneral
    Dim ComplaintReturn As ComplaintReturnMasterBE
    Dim objDAL As ComplaintReturnMasterDAL
    ...
    Private Sub btnAddDock_Click(sender As Object, e As EventArgs) Handles btnAddDock.Click
        frmComplaintReturn.ComplainReturnId = 0
        frmComplaintReturn.EditMode = False
        frmComplaintReturn.Post = False
        frmComplaintReturn.btnSave.Visible = True
        frmComplaintReturn.btnPost.Visible = False
        frmComplaintReturn.btnPrint.Visible = False
        frmComplaintReturn.DoHaveFieldChooserRights = DoHaveFieldChooserRights
        frmComplaintReturn.DoHaveExportRights = DoHaveExportRights
        frmComplaintReturn.DoHavePrintRights = DoHavePrintRights
        frmComplaintReturn.DoHaveSaveRights = DoHaveSaveRights
        frmComplaintReturn.ShowDialog()
        GetAllRecords()
    End Sub
    ...
    Public Sub ApplyGridSettings(Optional Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            Me.grdBranchList.RootTable.Columns("ComplaintReturnId").Visible = False
    ...
    Public Sub GetAllRecords(Optional Condition As String = "") Implements IGeneral.GetAllRecords
        Try
            objDAL = New ComplaintReturnMasterDAL
    ...
    Private Sub grdBranchList_DoubleClick(sender As Object, e As EventArgs) Handles grdBranchList.DoubleClick
        Try
            If Me.grdBranchList.RowCount > 0 Then
                frmComplaintReturn.ComplainReturnId = Val(Me.grdBranchList.CurrentRow.Cells("ComplaintReturnId").Value.ToString)
                frmComplaintReturn.EditMode = True
                frmComplaintReturn.Post = Val(Me.grdBranchList.CurrentRow.Cells("Posted").Value.ToString)
                frmComplaintReturn.btnPost.Visible = True
                frmComplaintReturn.btnPrint.Visible = True
                frmComplaintReturn.DoHaveUpdateRights = DoHaveUpdateRights
                frmComplaintReturn.DoHavePostRights = DoHavePostRights
                frmComplaintReturn.DoHavePrintRights = DoHavePrintRights
                frmComplaintReturn.DoHaveFieldChooserRights = DoHaveFieldChooserRights
                frmComplaintReturn.DoHaveExportRights = DoHaveExportRights
            Else
    ...
    Private Sub grdBranchList_ColumnButtonClick(sender As Object, e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grdBranchList.ColumnButtonClick
        Try
            ComplaintReturn = New ComplaintReturnMasterBE
            ComplaintReturn.ComplaintReturnId = Val(Me.grdBranchList.CurrentRow.Cells("ComplaintReturnId").Value.ToString)
            ComplaintReturn.ComplaintReturnNo = Me.grdBranchList.CurrentRow.Cells("ComplaintReturnNo").Value.ToString
            ComplaintReturn.ComplaintId = Val(Me.grdBranchList.CurrentRow.Cells("ComplaintId").Value.ToString)
            ComplaintReturn.Post = CBool(Me.grdBranchList.CurrentRow.Cells("Posted").Value)

            Voucher = New VouchersMaster()
            Voucher.VoucherId = 0
            Voucher.BankDescription = ""
            Voucher.VoucherCode = ComplaintReturn.ComplaintReturnNo
            ...
            If e.Column.Key = "Delete" Then
                ...
                If DoHaveDeleteRights = True Then
                    objDAL.Delete(ComplaintReturn, Voucher)
                    Me.grdBranchList.GetRow.Delete()
                    SaveActivityLog("Complaint Return", Me.Text, EnumActions.Delete, LoginUserId, EnumRecordType.Configuration, Me.Text, True)
                Else
