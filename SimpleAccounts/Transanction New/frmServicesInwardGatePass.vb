...
Public Class frmServicesInwardGatePass
    ...
    Public Sub ApplyGridSettings(Optional ByVal Condition As String = "") Implements IGeneral.ApplyGridSettings
        Try
            ...
            For Each c As Janus.Windows.GridEX.GridEXColumn In Me.grd.RootTable.Columns
                If c.Index <> EnmGridDt.Qty AndAlso c.Index <> EnmGridDt.Detail AndAlso c.Index <> EnmGridDt.Unit AndAlso c.Index <> EnmGridDt.Price AndAlso c.Index <> EnmGridDt.PreviousQty Then
    ...
    Public Sub ReSetControls(Optional ByVal Condition As String = "") Implements IGeneral.ReSetControls
        Try
            ...
            ElseIf Condition = "ClearItemForGrid" Then
                ...
                Me.txtPreviousQty.Text = String.Empty
    ...
    Private Sub grd_CellUpdated(sender As Object, e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles grd.CellUpdated
        Try
            If e.Column.Key = "PreviousQty" Then
                'Ali Faisal : commented this line to restrict that both qty cann't be same
                'grd.GetRow.Cells(EnmGridDt.Qty).Value = grd.GetRow.Cells(EnmGridDt.PreviousQty).Value
            End If
        Catch ex As Exception
            ShowErrorMessage(ex.Message)
        End Try
        ...
        Try
            If GetSMSConfig("Inward / Outward Gate Pass").EnabledAdmin = True Then
                ...
                If obj IsNot Nothing Then
                    ...
                    strMessage = strMessage.Replace("@PartyName", Me.txtpartname.Text).Replace("@DocumentNo", Me.txtdcno.Text).Replace("@DocumentDate", Me.dcdate.Value.ToShortDateString).Replace("@BillNo", Me.txtbillno.Text).Replace("@Remarks", Me.txtremarks.Text).Replace("@Amount", Me.grd.GetTotal(grd.RootTable.Columns("Amount"), Janus.Windows.GridEX.AggregateFunction.Sum)).Replace("@Quantity", Me.grd.GetTotal(grd.RootTable.Columns("Qty"), Janus.Windows.GridEX.AggregateFunction.Sum)).Replace("@CompanyName", CompanyTitle).Replace("@SIRIUS", "Automated by www.SIRIUS.net")
