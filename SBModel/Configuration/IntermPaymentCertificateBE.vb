Public Class IntermPaymentCertificateBE
    ...
    Public Property Detail As List(Of IntermPaymentCertificateDetailBE)

End Class


Public Class IntermPaymentCertificateDetailBE
